...
Aims: BART overview + useful packages in `R`
...
Defaults in @chipman2010 work well empirically. 
 ...
 - Except for binary outcomes [@dorie2016flexible]
...
head(posterior_treatment %>% select(-.chain, -.iteration))
...
<https://CRAN.R-project.org/package=tidytreatment>
